  ...
  if (palettes.length === 0) {
    return (
      <div className="rounded-xl border border-dashed border-white/10 px-3 py-4 text-center text-xs text-slate-500">
        <p className="font-medium text-slate-400">Todavia no hay paletas guardadas</p>
        <p className="mt-1 text-[11px] text-slate-600">Guarda una para compartirla o reutilizarla despues.</p>
      </div>
    );
  }
        ...
        return (
          ...
          >
            <button
              ...
              aria-label={`Seleccionar ${palette.name}`}
              title={palette.name}
            >
            ...
            <div className="mt-3 flex items-center gap-2">
              <div className="flex min-w-0 flex-1 items-center gap-1.5 overflow-x-auto pb-0.5">
                {colors.length > 0 ? (
                  ...
                  <span className="text-[11px] text-slate-600">Sin colores</span>
                )}
              </div>
    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-center justify-between gap-2 rounded-2xl border border-white/10 bg-black/20 px-3 py-2">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <span className="truncate text-[11px] font-medium uppercase tracking-[0.08em] text-slate-400">Paletas</span>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-black/20 p-2">
        <div className="mb-2 flex items-center justify-between gap-2 px-1">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] font-medium uppercase tracking-[0.06em] text-slate-500">Guardadas</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label="Importar paleta JSON"
              title="Importar JSON"
            >
