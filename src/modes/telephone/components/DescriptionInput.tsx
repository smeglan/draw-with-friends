...
export function DescriptionInput({ onSubmit, disabled }: Props) {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-6 p-6">
      <h2 className="text-center text-lg font-medium text-white">
        {t("telephone.descriptionPrompt")}
      </h2>
      <p className="max-w-md text-center text-sm text-slate-400">
        {t("telephone.descriptionHint")}
      </p>
      <div className="flex w-full max-w-md flex-col gap-3">
        <textarea
          ...
          placeholder={t("telephone.descriptionPlaceholder")}
          disabled={disabled}
          rows={4}
